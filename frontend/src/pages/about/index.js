    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/maksimon17/foodgram-st" className={styles.textLink}>maksimon17</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="Антонов Максим" className={styles.textLink}>Антонов Максим</a>
            </p>
          </div>
        </aside>
      </div>
